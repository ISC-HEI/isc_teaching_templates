...
\usepackage{accsupp}
% NOTE: do *not* redefine \thelstnumber here. \refstepcounter{lstnumber} puts it
% into \@currentlabel, and hyperref re-expands that inside an \xdef, where the
% \BeginAccSupp keyval parsing collides with the active `/` installed by
% escapeinside={/*@}{@*/} -> "Undefined control sequence \lst@IfNextCharsArg".
% Applying the wrapper through numberstyle keeps it purely at typesetting time.
\newcommand{\noncopynumber}[1]{%
...
\newmdenv[rightline=false,bottomline=false,topline=false,linewidth=3pt,linecolor=blockquote-border,skipabove=\dimexpr\parskip+6pt\relax]{customblockquote}
\renewenvironment{quote}{\begin{customblockquote}\list{}{\rightmargin=0em\leftmargin=0em}%
\item\relax\color{blockquote-text}\ignorespaces}{\unskip\unskip\endlist\end{customblockquote}}

%
% ISC callouts -- coloured boxes driven by the lua_filters/callouts.lua filter.
%
% In the markdown source, a fenced div produces the corresponding box:
%
%   ::: checkout                     -> \begin{isccheckout} ... \end{isccheckout}
%   ::: warning                      -> \begin{iscwarning}  ... \end{iscwarning}
%   ::: info                         -> \begin{iscinfo}     ... \end{iscinfo}
%   ::: {.warning title="Sur macOS"} -> same, with the default title replaced
%
% The colours are the official ISC programme colours.
%
\tcbuselibrary{breakable}

\definecolor{isc-embedded}{RGB}{152,199,191} % Systemes informatiques embarques
\definecolor{isc-security}{RGB}{226,171,186} % Securite informatique
\definecolor{isc-networks}{RGB}{168,144,192} % Reseaux et systemes
\definecolor{isc-software}{RGB}{140,198,230} % Informatique logicielle
\definecolor{isc-data}{RGB}{247,241,159}     % Ingenierie des donnees
...
\newtcolorbox{isccheckout}[1][]{isccallout=isc-embedded, title=Checkout, #1}
\newtcolorbox{iscwarning}[1][]{isccallout=isc-security, title=Attention, #1}
\newtcolorbox{iscinfo}[1][]{isccallout=isc-software, title=Info, #1}
