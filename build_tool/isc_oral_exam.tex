...
% Specific sections formatting using KOMA-Script compatible approach
\RedeclareSectionCommand[
  beforeskip=0.05\baselineskip,
  afterskip=0.1\baselineskip,
  font=\normalfont\fontsize{14pt}{16pt}\selectfont\bfseries\color{darkgray}
]{section}
\RedeclareSectionCommand[
...
% Hide section numbering (was implicitly hidden by titlesec's empty label format)
\setcounter{secnumdepth}{0}

% Add horizontal rules around section titles only (not subsections)
\makeatletter
...
\begin{tikzpicture}[remember picture,overlay]
    ...
    \includegraphics[height=1.425cm]{figs/ISC Logo inline black v3.pdf}
	};
\end{tikzpicture}
